...
MAKE_BIN=/usr/local/sh-elf/sh-elf/lib/libstdc++.a
...
$(MAKE_BIN):
	cd $(MAKE_BUILD_DIR) && \
	../src/gcc-5.3.0/configure --target=sh-elf --prefix=/usr/local/sh-elf/ --with-gnu-as --with-gnu-ld --with-newlib --with-multilib-list=m2e --without-headers --enable-languages=c,c++ --disable-nls --disable-libssp --disable-libada --disable-libquadmath --disable-libgomp

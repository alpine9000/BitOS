...
clock_t _times_r (struct _reent *reent, struct tms *tp)
{
...
pid_t _wait_r(struct _reent *reent, int *stat_loc)
{
...
int _rename_r(struct _reent *re, const char *old, const char *new)
{
...
void* _calloc_r(struct _reent* reent, size_t n, size_t m)
{

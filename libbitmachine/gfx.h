...
void gfx_drawPixel(unsigned fb, int x, int y, unsigned byte);
...
#define gfx_drawStringEx(fb, x, y, c, color, size, spaceSize)  _bft->gfx_drawStringEx(fb, x, y, c,  color, size, spaceSiz)

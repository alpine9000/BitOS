...
extern int rlreply (char *prompt, char *buf, int nbuf);
...
int fileread (int f, int n)
{
  ...
  if ((s = rlreply ("Read file: ", fname, NFILEN)) != TRUE)
    return (s);
  return (readin (fname));
}
...
int insfile (int f, int n)
{
  ...
  if ((s = rlreply ("Insert file: ", fname, NFILEN)) != TRUE)
    return (s);
  return (ifile (fname));
}
...
int filefind (int f, int n)
{
  ...
  if ((s = rlreply ("Find file: ", fname, NFILEN)) != TRUE)
    return (s);
...
int filewrite (int f, int n)
{
  ...
  if ((s = rlreply ("Write file: ", fname, NFILEN)) != TRUE)
    return (s);
...
int filename (int f, int n)
{
  ...
  if ((s = rlreply ("Name: ", fname, NFILEN)) == ABORT)
    return (s);
  if (s == FALSE)
